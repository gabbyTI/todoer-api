...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::put('tasks/{task}/project/{project}', [TaskController::class, 'moveTaskToProject']);
    ...
    Route::delete('projects/{project}/user/{user}', [ProjectController::class, 'removeFromProject']);

    //Invitation
    Route::post('invitation/{project}', [InvitationController::class, 'invite']);
    Route::post('invitation/{invitation}/resend', [InvitationController::class, 'resend']);
    Route::post('invitation/{invitation}/respond', [InvitationController::class, 'respond']);
